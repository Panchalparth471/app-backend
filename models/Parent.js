...
const parentSchema = new mongoose.Schema({
  ...
  preferences: {
    language: { type: String, default: 'en', enum: ['en','es','fr','de','it','pt','zh','ja','ko'] },
    ...
    contentPreferences: {
      themes: [{ type: String, enum: ['kindness','courage','friendship','learning','creativity','nature','family'] }],
      ageAppropriate: { type: Boolean, default: true },
      educationalFocus: [{ type: String, enum: ['language','math','science','art','music','social','emotional'] }]
    }
  },
  voiceSettings: {
    hasVoiceClone: { type: Boolean, default: false },
    voiceCloneId: { type: String, default: '' },
    voicePreferences: {
  ...
  chats: [
    { type: mongoose.Schema.Types.ObjectId, ref: 'Chat' } // <-- added: allow referencing chat docs
  ],
  isActive: { type: Boolean, default: true },
